...
if(__name__=="__main__"):
    ...
    m.submodules.Memory_file = Memory_file1 = Memory_file()
    ...
    m.d.comb += Memory_file1.load.eq(load)
    m.d.comb += Memory_file1.addr.eq(addr)
    m.d.comb += Memory_file1.write.eq(write)
    m.d.comb += Memory_file1.data_in.eq(data_in)
