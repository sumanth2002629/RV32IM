...
class Wrapper(Elaboratable):
    ...
    def elaborate(self,platform:Platform)->Module:
        ...
        # m.d.sync += self.IF.mem[Const(3)].eq(0x00300793)
        # m.d.sync += self.IF.mem[Const(4)].eq(0xfef42623)
        # m.d.sync += self.IF.mem[Const(5)].eq(0xfec42783)
        # m.d.sync += self.IF.mem[Const(6)].eq(0x02f787b3)
        # m.d.sync += self.IF.mem[Const(7)].eq(0xfec42703)
        # m.d.sync += self.IF.mem[Const(8)].eq(0x02f707b3)
        # m.d.sync += self.IF.mem[Const(9)].eq(0xfef42423) #mul
        # m.d.sync += self.IF.mem[Const(10)].eq(0x00000013)
        # m.d.sync += self.IF.mem[Const(11)].eq(0x01c12403) 
        # m.d.sync += self.IF.mem[Const(12)].eq(0x02010113)
        # m.d.sync += self.IF.mem[Const(13)].eq(0x00008067)
